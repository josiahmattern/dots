  ...
  config = function()
    ...
    mason_lspconfig.setup({
      ...
      handlers = {
        ...
        -- add this inside your mason_lspconfig.setup({ handlers = { … } })
        lua_ls = function()
          require('lspconfig').lua_ls.setup({
            ...
            settings = {
              Lua = {
                runtime = {
                  -- use Lua 5.1 for Love2D
                  version = 'Lua 5.1',
                  -- make sure the server finds your `require`d modules
                  path = vim.split(package.path, ';'),
                },
                diagnostics = {
                  -- recognize the `love` global
                  globals = { 'vim', 'love' },
                },
                workspace = {
                  -- load library files from Neovim and your plugins
